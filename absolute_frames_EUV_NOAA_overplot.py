...
ax1.set_title('EUV Plage Regions: Centroid Latitude vs Time', y=1.01, fontsize=font_size)
ax1.set_xlabel('Date', fontsize=font_size)
ax1.set_ylabel('Latitude [Deg]', fontsize=font_size)

#plt.savefig('C:/Users/Brendan/Desktop/Inbox/Latitude_vs_Time_Scatter_0thresh.pdf', bbox_inches='tight')
