# -*- coding: utf-8 -*-
"""
Created on Mon Jul 24 12:31:37 2017
...
#for w1 in range(1):
    ...
    for w2 in range(4):
        ...
        if w1 == 0 and w2 == 0:
            ...
            plt.xlabel('Active Longitude Threshold', fontsize=font_size)
        if count1 == count2:
            plt.hlines(int_tot_avg, 0, 14, color='%s' % color[w1], linewidth=2, linestyle='dashed')   
            plt.hlines(int_tot_med, 0, 14, color='%s' % color[w1], linewidth=2, linestyle='solid')
            count1 += 5
        count2 += 1
...
#plt.savefig('C:/Users/Brendan/Desktop/AL_Intensity_Vs_Threshold_Smoothing_%sE.jpeg' % hemi, bbox_inches='tight')    
#"""